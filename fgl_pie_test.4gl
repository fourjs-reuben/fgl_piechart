...
DEFINE g fgl_pie.pie_rec

CONSTANT UNIMPLEMENTED_FIELDS_LIST="data_tooltip is3d font_size font_name background_color_stroke background_color_stroke_width chart_area_background_color_stroke chart_area_background_color_stroke_width legend_alignment  legend_max_lines slice_text_style_color slice_text_style_font_name slice_text_style_font_size tooltip_ignore_bounds tooltip_is_html tooltip_show_color_code tooltip_text tooltip_text_style_color tooltip_text_style_font_name tooltip_text_style_font_size tooltip_text_style_weight tooltip_text_style_font_style tooltip_trigger"
...
END RECORD
    ...
    OPEN WINDOW pie_test WITH FORM "fgl_pie_test"

    DIALOG ATTRIBUTES(UNBUFFERED)
        INPUT ARRAY data FROM data_scr.* ATTRIBUTES(WITHOUT DEFAULTS=TRUE)
        END INPUT

        INPUT g.title, g.title_position.x, g.title_position.y, g.title_position.alignment,  g.title_text_style.color, g.title_text_style.font_name, g.title_text_style.font_size, g.title_text_style.weight, g.title_text_style.font_style
        FROM title, title_position_x, title_position_y, title_position_alignment, title_text_style_color, title_text_style_font_name, title_text_style_font_size, title_text_style_weight, title_text_style_font_style
        ...
        INPUT g.legend.alignment, g.legend.position, g.legend.max_lines,
              g.legend.text_style.color, g.legend.text_style.font_name, g.legend.text_style.font_size, g.legend.text_style.weight, g.legend.text_style.font_style
        FROM legend_alignment, legend_position, legend_max_lines,
             legend_text_style_color, legend_text_style_font_name, legend_text_style_font_size, legend_text_style_weight, legend_text_style_font_style
        ATTRIBUTES (WITHOUT DEFAULTS=TRUE)
        END INPUT
        ...
        INPUT g.pie_hole, g.pie_slice.border_color, g.pie_slice.text, 
              ...
              g.pie_start_angle, g.reverse_categories, g.pie_slice.border_width
        FROM pie_hole, pie_slice_border_color, pie_slice_text, 
             ...
             pie_start_angle, reverse_categories, pie_slice_border_width
        ATTRIBUTES (WITHOUT DEFAULTS=TRUE)
        END INPUT
        ...
        g.tooltip.text_style.color, g.tooltip.text_style.font_name, g.tooltip.text_style.font_size, g.tooltip.text_style.weight, g.tooltip.text_style.font_style, 
        g.tooltip.trigger
        FROM tooltip_ignore_bounds, tooltip_is_html, tooltip_show_color_code, tooltip_text,
        tooltip_text_style_color, tooltip_text_style_font_name, tooltip_text_style_font_size, tooltip_text_style_weight, tooltip_text_style_font_style, 
        tooltip_trigger
        ATTRIBUTES (WITHOUT DEFAULTS=TRUE)
        END INPUT
        ...
        BEFORE DIALOG
            -- Disable all unimplemented fields
            CALL disable_unimplemented_fields(DIALOG)
        ...
        ON ACTION draw ATTRIBUTES(TEXT="Draw")
            ...
            CALL fgl_pie.draw("formonly.wc", g.*)
        ...
        ON ACTION example5 ATTRIBUTES(TEXT="Example 5")
            ...
            LET data[22].label = "Urdu"     LET data[22].value = 52
        ...
        ON ACTION example8 ATTRIBUTES(TEXT="Example 8")
            CALL init_parameters()
            CALL data.clear()

            LET g.data_col_count = 2
            LET g.data_column[1].label = "Type"
            LET g.data_column[1].type = "string"
            LET g.data_column[2].label = "Value"
            LET g.data_column[2].type = "number"

            LET g.title = "DSR"
            LET g.title_position.x = 150
            LET g.title_position.y = 150
            LET g.title_text_style.weight = "bold"
            LET g.title_text_style.font_size = 24
   
            LET data[1].label = "DSR"  LET data[1].value = 550000-105000  LET data[1].color = "green"
            LET data[2].label = "Loan" LET data[2].value = 105000         LET data[2].color = "red"

            LET g.pie_hole = 0.6
            LET g.pie_start_angle = 180
        ...
        ON ACTION select ATTRIBUTES(DEFAULTVIEW=NO)
            CALL FGL_WINMESSAGE("Info",SFMT("Clicked element: %1", wc),"info")

        ON ACTION mouse_over ATTRIBUTES(DEFAULTVIEW=NO)
            MESSAGE SFMT("Mouse Over: %1", wc)
        ...
        #ON ACTION bbox
         #   CALL ui.Interface.frontCall("webcomponent","call",["formonly.wc","get_bbox","myrootsvg","Work"],result)
          #  DISPLAY result
...
FUNCTION disable_unimplemented_fields(d)
DEFINE d ui.Dialog
DEFINE tok base.StringTokenizer

    LET tok = base.StringTokenizer.create(UNIMPLEMENTED_FIELDS_LIST," ")
    WHILE tok.hasMoreTokens()
        CALL d.setFieldActive(tok.nextToken(),FALSE)
    END WHILE
END FUNCTION